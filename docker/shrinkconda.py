...
def get_size():
    ...
    decoded_output = o.decode('ascii')
    print(type(decoded_output))
    print(decoded_output)
    return int(decoded_output.split("\t")[0])
